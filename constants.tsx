...
export const INITIAL_USERS: User[] = [
  { id: 'admin_1', username: 'admin', role: 'ADMIN', password: 'adminpassword' },
  { id: 'vendor_1', username: 'burger_king', role: 'VENDOR', restaurantId: 'res_1', password: 'password123' },
  { id: 'vendor_2', username: 'zen_master', role: 'VENDOR', restaurantId: 'res_2', password: 'password123' },
  { id: 'vendor_3', username: 'pizza_chef', role: 'VENDOR', restaurantId: 'res_3', password: 'password123' },
];
